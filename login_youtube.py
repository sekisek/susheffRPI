...
PROFILE_KEY = profile_key_for("youtube", COLLECTOR_PROFILE_ID)
...
async def main():
    ...
    async with async_playwright() as p:
        ...
        print(f"\nManual YouTube login mode. profile_key={PROFILE_KEY}")
        print("Log in with the Google/YouTube account you want this Pi to use.")
        print("Solve any checkpoint, consent, or 2-step prompt if needed.")
